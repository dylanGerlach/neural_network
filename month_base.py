...
(train_inputs, train_targets) = make_inputs_and_targets(
    train_data, train_months, train_size, sampling
)

(val_inputs, val_targets) = make_inputs_and_targets(
    val_data, val_months, val_size, sampling
)

(test_inputs, test_targets) = make_inputs_and_targets(
    test_data, val_months, test_size, sampling
)
...
history_dense = build_and_train_dense(
    train_inputs, train_targets, val_inputs, val_targets, filename
)
...
"""
This is commented out, will be included in homework 6
